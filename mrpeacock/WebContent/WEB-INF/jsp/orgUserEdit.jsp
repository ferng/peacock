						...
						<tr>
							<form:form method="post" modelAttribute="user">
								<form:errors path="*" cssClass="error" />
 								<td>
									<form:input disabled="${userIdEditable}" path="userId" maxlength="${userIdSize}"/>
									<form:errors path="userId" cssClass="error"/>
								</td>
								<td>
									<form:select path="userOrg" multiple="false">
										<form:options items="${orgCodeList}"/>
									</form:select>
								</td>
								<td>
									<form:input path="userFname" maxlength="${userFnameSize}" />
									<form:errors path="userFname" cssClass="error" />
								</td>
                <td>
                  <form:input path="userSname" maxlength="${userSnameSize}" />
                  <form:errors path="userSname" cssClass="error" />
                </td>
                <td>
                  <form:input path="userPw" maxlength="${userPwSize}" />
                  <form:errors path="userPw" cssClass="error" />
								...
								<td> <input type="submit" value="${userEditAction}"/> </td>
								<td> <input type="button" value="Cancel" onclick="location.href='orgShowAllUsers?orgId=${user.userOrg}'"/> </td>
			 				</form:form>
						</tr>
					</table>
				</td>
